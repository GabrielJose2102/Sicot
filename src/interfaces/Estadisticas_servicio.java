 ...
 * @author usuario
 */
public class Estadisticas_servicio extends javax.swing.JFrame {
    ...
    int[] vector_marcas_cantidad = new int[14];
    String[] vector_tipos_nombre = new String[14];
    int OGH, AUI, COJ, CBI, COC, CCT, CMER, CSG, CTE, DAG, GCC, GCM, GGE, OGA, OPP, OTI, GPR, GPC, SAS;

    /**
     * Creates new form Estadisticas_reporte
     */
    public Estadisticas_servicio() {
        initComponents();
        setTitle("Estadisticas de Servio Tecnico");
        setResizable(false);
        setSize(1100, 760);
        ...
        if (!desde.equals("----------") && !hasta.equals("----------")) {
                ...
                e_servicio.setText("Servicio tecnico: " + desde + "    " + hasta);
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement(
                        "SELECT id_departamento, COUNT(id_departamento) AS total_reportes "
                                ...
                                + "WHERE tipo_reporte = 'Servicio Tecnico' "
    ...
    private void initComponents() {
        ...
        e_servicio = new javax.swing.JLabel();
        ...
        e_listar_usuarios_titulo.setText("Resumen Servicio Técnico");
        panelRound8.add(e_listar_usuarios_titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 0, 340, 100));
        ...
        panelRound8.add(b_salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 20, 80, 60));

        panelRound5.add(panelRound8, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 20, 980, 100));
        ...
        e_servicio.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        e_servicio.setForeground(new java.awt.Color(0, 0, 0));
        e_servicio.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        e_servicio.setText("Servicio Técnico");
        getContentPane().add(e_servicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 140, 560, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Estadisticas_servicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Estadisticas_servicio().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel e_servicio;
